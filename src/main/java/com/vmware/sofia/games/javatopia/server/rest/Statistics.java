...
public class Statistics {
	...
	String[] bg = new String[] {
			...
			"FFECB0", "DD75DD", "CEB98",  "A095EE", "99FD77", "E697E6", 	"FFFF84", "8EB4E6", "EAA6EA", "DFB0FF", "CEB98",  "A095EE", "99FD77"
	};
	...
	public String returnStatistics() {
		...
		results.append("<html><head><meta http-equiv=\"refresh\" content=\"200\" </title> <body>");
		for (int sector=1; sector<=10; sector++) {
			...
			try {
				...
				results.append(dumpTable(sectorObjects,"<b>"+"Sector "+sector+"</b><br/>",bg[sector]));
		}	
		results.append(dumpTable(globalObjects,"<b>"+"Global result </b><br/>", bg[0]));
		results.append("</body>");
		return results.toString();
	}

	public String dumpTable(LinkedHashMap<String, Integer> statistics, String title, String bg) {
		if (statistics.size()==0) {
			return "<br/><Center>No information available yet for "+title+"</Center>";
		}
	    ...
	    result.append("<table align=\"right\" cellspacing=\"10\" border=\"1\" bgcolor=\"#"+bg+"\"><tr><td colspan=\"2\">"+title+"</td></tr>");
	    for (Entry<String, Integer> ent: list) {
	      	 result.append("<tr><td><FONT COLOR=\"#44000\">"+ent.getKey()+"</font></td><td><FONT COLOR=\"#00044\">"+ent.getValue()+"</font></td></tr>");
	    }
	    result.append("</table>");
	...
	public void incPlayer(LinkedHashMap<String, Integer> statistics, String player) {
